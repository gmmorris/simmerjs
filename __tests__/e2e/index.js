...
const compareElementsAndSimmer = (browser, selector, onFinish = () => browser.end()) => {
...
module.exports = { 
  ...
  'can analyze an element which is a child of an element with an ID': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'can analyze anelement which has a class only (no IDs on it or its direct parent)': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'can analyze an element with an invalid ID (isnt unique) at same level as other element with the same ID': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'can analyze an element with identical siblings (neither unique ID nor class)': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'can analyze an element with a parent which has identical siblings': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'can analyze a child of a hierarchy with identical siblings and no unique IDs': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'can analyze an anchor (link) with a unique href attribute': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'can analyze a link with a non unique href attribute and a heirarchy which has no unique IDs': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'can analyze an element with identical siblings, no IDs and sibling with the same class': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'can analyze an element with identical siblings, no ID and same class as sibling but different class order': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'can analyze an element with identical siblings, no ID and different classes completely': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'cannot parse an element with an identical hierarchy whithin the Simmers default configured depth': function(browser) {
  ...
  'can analyze an element with a parent which has an invalid Tag name': function(browser) {
  ...
  'can analyze an element based only on child elements when specific enough at level 1': function(browser) {
  ...
  'can analyze an element based only on child elements when specific enough at level 2': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
    
    compareElementsAndSimmer(browser,  '.secondLevelUniqueClassName div', selector => {
      // make sure the selector is one level deep
  ...
  'can analyze an element with a valid ID that ends with numbers in its ID': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
    
    const selector = compareElementsAndSimmer(browser,   '#a111', selector => {
      browser.assert.equal(selector.match('a111')[0], 'a111');
      browser.end();
    });
  },

  'can analyze an element with a valid ID that has numbers in the middle of its ID': function(browser) {
    browser
      .url('localhost:3993')   // visit the local url
      .waitForElementVisible('body'); // wait for the body to be rendered
  ...
  'cant analyze an element which is longer than the selectorMaxLength chars': function(browser) {
    // const windowScope = createWindow(fixture);
